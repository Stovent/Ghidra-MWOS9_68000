 ...
 * @author Stovent
 */
public class SystemHeader implements Structure {
    public static final String NAME = "System Header";
    ...
    public SystemHeader(ByteProvider provider) throws IOException {
